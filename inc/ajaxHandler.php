...
function payment_ajax()
{
    ...
    if (isset($_REQUEST)) {
        ...
        if (!$plan || !$user_id) $errMsg .= 'حطا در انجام عملیات!';
...
//        $date = $date->format("Y-m-d H:i:s");
        ...
        $errors = ['age' => 0, 'gender' => 0, 'height' => 0, 'weight' => 0, 'diseases' => 0, 'phone' => 0, 'fullname' => 0];
...
//            $user_id = $db->get_row_last($db->table_users)->ID;
